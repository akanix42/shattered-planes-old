...
CollisionComponent = (_dec = (0, _jsonc.serializable)('CollisionComponent'), _dec(_class = function (_Component) {_inherits(CollisionComponent, _Component);
  function CollisionComponent() {_classCallCheck(this, CollisionComponent);var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CollisionComponent).call(this));

    _this.addHandler(_events2.default.move, 50, _this.onPosition);
    _this.addHandler(_events2.default.willNotCollide, 50, _this.onWillNotCollide);return _this;}_createClass(CollisionComponent, [{ key: 'onPosition', value: function onPosition(
    ...
    {
      return false;} }]);return CollisionComponent;}(_Component3.default)) || _class);



CollisionComponent._name = 'collision';exports.default = 
