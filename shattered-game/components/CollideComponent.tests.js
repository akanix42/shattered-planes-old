'use strict';
var _CollidableComponent = require('./CollidableComponent');var _CollidableComponent2 = _interopRequireDefault(_CollidableComponent);
...
describe('CollidableComponent', function () {
  describe('onPosition', function () {
    it('should emit a willNotCollide event', function () {
      var collideComponent = new CollideComponent();
