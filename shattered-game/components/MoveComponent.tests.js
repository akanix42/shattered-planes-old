...
MoveComponent = function (_Component) {_inherits(MoveComponent, _Component);
  function MoveComponent() {_classCallCheck(this, MoveComponent);var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MoveComponent).call(this));

    _this.addHandler(_events2.default.move, 100, _this.move);return _this;}_createClass(MoveComponent, [{ key: 'move', value: function move(


    event) {
      this.entity.tile = event.destination;} }]);return MoveComponent;}(_Component3.default);exports.default = 
