...
suite
  .add('SubscribedHandlers#add#remove', function () {
  ...
  .add('SubscribedHandlers2#add#remove', function () {
    subscribedHandlers.add(subscription);
    subscribedHandlers.remove(subscription);
  }, {
    setup: function () {
  ...
  .add('PrioritizedHandlers#add#remove', function () {
    prioritizedHandlers.add(handler);
    prioritizedHandlers.remove(handler);
  }, {
    setup: function () {
      // global.require('babel-register');
